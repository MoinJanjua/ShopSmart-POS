...
class RecordsViewController: UIViewController {
    ...
    func generatePDF() -> Data {
        let pdfMetaData = [
            kCGPDFContextCreator: "ShopSmart POS",
            
            kCGPDFContextTitle: "Trade All Data"
        ]
    ...
    @IBAction func PdfGenerateButton(_ sender: Any) {
        // Generate PDF
           ...
           let pdfPath = tempDirectory.appendingPathComponent("SalesData.pdf")
