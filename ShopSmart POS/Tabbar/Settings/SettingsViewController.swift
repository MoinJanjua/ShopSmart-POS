...
class SettingsViewController: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate{
    ...
    var settingImgs = ["-home","ab","share-100","-feedback","-share-","privacy-96"]
    ...
    func loadData() {
        // Load text fields
        userNameLbl.text = UserDefaults.standard.string(forKey: "name")
        userBioLbl.text = UserDefaults.standard.string(forKey: "description")
...
extension SettingsViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
            ...
            let appID = "ShopSmart POS" // Replace with your actual App ID
